...
return {
  ...
  config = function()
    ...
    vim.keymap.set('n', '<leader>fb', ":lua require('fzf-lua').grep_curbuf({ winopts = { fullscreen = false, height=0.90,width=0.80,row=0.5,col=0.5, preview = {} }})<cr>", { silent = true, desc = 'fuzzy find in buffer' })
