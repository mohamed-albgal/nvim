...
map{ key = '<Leader>rf',     cmd = ":let @+ = 'rspec ' . expand('%')<CR>",                    desc = "Yank the test file signature" }
map{ key = '<Leader>ry',     cmd = ":let @+ = 'rspec ' . expand('%') . ':' . line('.')<CR>",  desc = "Yank the test signature under the cursor" }
